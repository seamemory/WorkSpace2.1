package com.etc.project.utils;

import java.sql.*;

public class DBUtil {
    private static final String url="jdbc:mysql://127.0.0.1:3306/test2?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=Asia/Shanghai";
    //主机名,端口号,数据库名
